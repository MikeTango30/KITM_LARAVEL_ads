@extends('ads/main')
@section('promo')
    <div class="site-blocks-cover inner-page-cover overlay" style="background-image: url({!! asset('images/hero_2.jpg'); !!}" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="d-block d-md-flex listing vertical">
                                <a href="#" class="img d-block" style="background-image: url({!! asset('images/img_2.jpg') !!})"></a>
                                <div class="lh-content">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="d-block d-md-flex listing vertical">
                                <a href="#" class="img d-block" style="background-image: url({!! asset('images/img_3.jpg') !!})"></a>
                                <div class="lh-content">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="d-block d-md-flex listing vertical">
                                <a href="#" class="img d-block" style="background-image: url({!! asset('images/img_4.jpg') !!})"></a>
                                <div class="lh-content">
