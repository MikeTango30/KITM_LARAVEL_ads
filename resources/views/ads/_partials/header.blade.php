        ...
        <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
                ...
                <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
                    ...
                    <li class="ml-xl-3 login"><a href="{{ url('/login') }}"><span class="border-left pl-xl-4"></span>Prisijungti</a></li>

                    <li><a href="{{ url('/register') }}" class="cta"><span class="bg-primary text-white rounded">Registruotis</span></a></li>
                </ul>
            </nav>
        </div>
